...
function ImputForm({ onCompare }) {
  ...
  // Função auxiliar para buscar sugestões usando Nominatim (consulta livre)
  ...
  // Debounce para "Local de Partida" – dispara quando o texto muda
  useEffect(() => {
  ...
  // Evento onFocus: se houver texto suficiente, refaz a busca
