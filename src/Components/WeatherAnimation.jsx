...
const CLOUDY_TIME = 30;   // Ex.: 6 segundos para "cloudy"
const STORM_TIME = 60;   // Ex.: 12 segundos para "storm"
const CYCLE_TIME = 120;   // Ex.: 18 segundos para reiniciar e voltar a "sunny"
